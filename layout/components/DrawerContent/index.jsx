      ...
      >
        ...
        >
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            ...
            <View>
              ...
              <Caption style={styles.caption}>daovanluong@gmail.com</Caption>
            </View>
          </View>

          <View style={styles.row}>
            <View style={styles.section}>
              <Title style={[styles.caption, styles.followTitle]}>80 </Title>
        ...
        <View style={{ backgroundColor: '#fff' }}>
          <DrawerItem
            label='Home'
            icon={({ color, size }) => (
              <Icon name='home-outline' color={'#333'} size={size} />
            )}
            labelStyle={{ fontSize: 15, marginLeft: -20, color: '#333' }}
            onPress={() => {}}
          />
          <DrawerItem
            label='Home'
