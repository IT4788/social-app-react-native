...
import RequestedFriendItem from './RequestedFriendItem';
import { getRequestedFriend } from '../../../services/friend';
...
const RequestedFriendsScreen = () => {
  ...
  useEffect(() => {
    ...
    getRequestedFriend({ numberPage: 1 }).then((data) => {
      setTotalPage(
...
export default RequestedFriendsScreen;
