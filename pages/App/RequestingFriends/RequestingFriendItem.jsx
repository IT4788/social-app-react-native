...
import { cancelFriendRequest } from '../../../services/friend';

const RequestingFriendItem = ({ friend, onDecreaseTotal }) => {
    ...
    <View>
      ...
      >
        ...
        <View style={styles.friendInfoWrapper}>
          ...
          {isCancelled ? (
            <AppText styles={styles.cancelText}>Đã hủy yêu cầu</AppText>
          ) : (
            <TouchableOpacity
...
export default RequestingFriendItem;
