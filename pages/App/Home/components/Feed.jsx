  ...
  return (
    <>
      <Container>
        <Header>
          <Row>
            <Avatar source={require('../../../../assets/images/user3.jpg')} />
        ...
        <Photo source={require('../../../../assets/images/post1.jpg')} />
      ...
      <Container>
        <Header>
          <Row>
            <Avatar source={require('../../../../assets/images/user2.jpg')} />
            <View style={{ paddingLeft: 10 }}>
              <User>Wanessa J</User>
              <Row>
                <Time>9m</Time>
        ...
        <Post>Post user</Post>
        <Photo source={require('../../../../assets/images/post2.jpg')} />
